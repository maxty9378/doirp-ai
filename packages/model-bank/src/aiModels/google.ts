 ...
 *
 * Ограничение: только одна модель (Gemini 2.5 Pro) для интерфейса.
 * ID gemini-2.5-pro поддерживается в Google AI API (generativelanguage.googleapis.com) v1beta.
 */
...
const googleChatModels: AIChatModelCard[] = [
  {
    ...
    description:
      'Gemini 2.5 Pro — самая продвинутая модель Google для сложных задач, код, математика, длинный контекст.',
