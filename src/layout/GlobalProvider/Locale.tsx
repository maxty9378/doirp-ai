...
const updateDayjs = async (lang: string) => {
  ...
  // dayjs uses short codes (en, ru) or locale like en-gb; refs: https://github.com/lobehub/lobe-chat/issues/3396
  const localeCandidates =
    normalized === 'en-us'
      ? ['en']
      : [normalized, normalized.split('-')[0]].filter((v, i, a) => a.indexOf(v) === i);
