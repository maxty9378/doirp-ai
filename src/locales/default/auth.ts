export default {
  ...
  'betterAuth.errors.accountContactAdmin':
    'Account not found. Contact administrator to get an access code.',
  ...
  'betterAuth.signin.codePlaceholder': 'Enter your code',
  'betterAuth.signin.codeRequired': 'Code is required',
  'betterAuth.signin.orContinueWith': 'OR',
  'betterAuth.signin.orSignInWithCode': 'Or sign in with code',
  'betterAuth.signin.passwordPlaceholder': 'Enter your password',
  'betterAuth.signin.signInWithCode': 'Sign in with code',
  ...
  'footer.agreement':
    'By continuing, you confirm that you have read and agree to the Terms of Use and Privacy Policy.',
  ...
  'signin.title': 'Агенты-команда, которые растут вместе с вами',
  'signout': 'Log Out',
  'signup': 'Sign Up',
