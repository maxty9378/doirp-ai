export default {
  ...
  'artifact.thinking': 'Размышление',
  'artifact.thought': 'Процесс размышления',
  ...
  'extendParams.enableReasoning.desc':
    'Включите для развёрнутого ответа с размышлением. Выключите для быстрого ответа без размышления. <1>Подробнее</1>',
  'extendParams.enableReasoning.title': 'Включить размышление (глубокий ответ)',
  'extendParams.quickReply.title': 'Быстрый ответ (без размышления)',
