export default {
  ...
  'confirm': 'Confirm',
  'draft.description': 'У вас есть несохранённый черновик. Хотите восстановить его?',
  'draft.ignore': 'Игнорировать',
  'draft.restore': 'Восстановить',
  'draft.title': 'Найдены несохранённые изменения',
