export default {
  ...
  'pageEditor.uploadError': 'Upload failed: {{message}}',
  'pageEditor.uploadParseError': 'Upload or parse failed: {{message}}',
  ...
  'pageEditor.exportErrorWordModule':
    'Не удалось экспортировать страницу. Выполните в корне проекта: pnpm install',
  'pageEditor.exportSuccess': 'Page exported successfully',
  'pageEditor.insertError': 'Не удалось вставить на страницу',
  'pageEditor.insertSuccess': 'Текст добавлен на страницу',
  'pageEditor.editorNotReady': 'Редактор ещё не готов',
  'pageEditor.linkCopied': 'Link copied',
  'pageEditor.history.empty': 'Нет сохранённых версий',
  'pageEditor.history.restore': 'Восстановить',
  'pageEditor.history.restoring': 'Восстановление...',
  'pageEditor.history.title': 'История версий',
  'pageEditor.menu.history': 'История версий',
  'pageEditor.menu.copyLink': 'Copy Link',
  'pageEditor.menu.export': 'Экспорт',
  'pageEditor.menu.export.markdown': 'Формат Markdown',
  'pageEditor.menu.export.word': 'Документ Word',
  ...
  'pageList.archive': 'Archive',
  'pageList.archiveEmpty': 'No deleted pages. Deleted pages are removed after 24 hours if not restored.',
  'pageList.deletedAt': 'Deleted {{time}}',
  'pageList.restore': 'Restore',
