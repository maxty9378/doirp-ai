export default {
  ...
  'telemetry.desc':
    'Добро пожаловать в ДОиРП AI — интеллектуальную среду для обучения и развития. Я помогаю проектировать образовательный контент, готовиться к тренингам и прокачивать бизнес-компетенции команды.',
