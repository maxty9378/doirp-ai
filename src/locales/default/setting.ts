...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'users.addSuccess': 'User added: {{email}}. Code: {{code}}',
  'users.addSuccessEmailPassword': 'User created. Login with email and password.',
  'users.addTitle': 'Add user',
  'users.addTokensButton': 'Add',
  'users.addTokensTitle': 'Add tokens',
  'users.addTokensTooltip': 'Increase token quota',
  'users.increaseQuotaSuccess': 'Quota increased by {{count}}',
  'users.increaseQuotaTitle': 'Increase quota by',
  'users.tokensShort': 'tokens',
  'users.setQuotaButton': 'Save',
  'users.setQuotaSuccess': 'Quota updated',
  'users.setQuotaTitle': 'Token quota',
  'users.setQuotaTooltip': 'Change quota',
  'users.copy': 'Copy',
  'users.codeColumn': 'Password',
  'users.deleteConfirmOk': 'Delete',
  'users.deleteConfirmTitle': 'Delete this user? This action cannot be undone.',
  'users.deleteSuccess': 'User deleted',
  'users.deleteUser': 'Delete user',
  'users.resetPassword': 'Reset password',
  'users.resetPasswordConfirmOk': 'Yes, reset',
  'users.resetPasswordConfirmTitle':
    'Are you sure? The password will be reset; you will need to share the new one with the user.',
  'users.hidePassword': 'Hide',
  'users.showPassword': 'Show',
  'users.createdColumn': 'Created',
  'users.passwordCopied': 'Copied',
  'users.loginMethodEmailPassword': 'Email + password',
  'users.daysAgo': '{{count}}d ago',
  'users.today': 'Today',
  'users.totalCount': 'Total: {{count}} users',
  'users.yesterday': 'Yesterday',
  'users.emailColumn': 'Email',
  'users.emailPlaceholder': 'user@example.com',
  'users.emailAlreadyRegistered': 'User with this email already exists',
  'users.emailRequired': 'Email is required',
  'users.passwordPlaceholder': 'Password',
  'users.passwordRequired': 'Password is required (min 6 characters)',
  'users.listTitle': 'User accounts',
  'users.loadError': 'Failed to load users',
  'users.overallUsage': 'Overall Usage',
  'users.statistics': 'Statistics',
  'users.tokenQuotaColumn': 'Token quota',
  'users.tokenQuotaPlaceholder': 'Token quota',
  'users.tokensUsedColumn': 'Tokens used',
  'users.totalQuota': 'Total Token Quota',
  'users.totalUsers': 'Total Users',
  'users.usageColumn': 'Token Usage',
  'users.usedTokens': 'Used Tokens',
