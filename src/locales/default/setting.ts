export default {
  ...
  'agentCronJobs.addJob': 'Добавить задачу по расписанию',
  ...
  'agentCronJobs.title': 'Задачи по расписанию',
  ...
  'danger.clear.title': 'Очистить данные',
  ...
  'danger.reset.title': 'Сбросить все настройки',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'voiceService.inputPlaceholder': 'Вставьте или введите текст для озвучки.',
  'voiceService.button': 'Озвучить',
  'voiceService.actions.clear': 'Очистить',
  'voiceService.actions.download': 'Скачать аудио',
  'voiceService.actions.edit': 'Изменить текст',
  'voiceService.actions.sample': 'Прослушать пример',
  'voiceService.actions.retrySample': 'Повторить',
  'voiceService.actions.select': 'Выбрать',
  'voiceService.actions.selected': 'Выбрано',
  'voiceService.adminOnly.action': 'Понятно',
  'voiceService.adminOnly.desc':
    'Функция озвучки доступна только администраторам. Если вам нужен доступ, обратитесь к администратору вашей организации.',
  'voiceService.adminOnly.title': 'Доступ ограничен',
  'voiceService.errors.emptyText': 'Введите текст для озвучки',
  'voiceService.errors.playback': 'Не удалось воспроизвести аудио',
  'voiceService.errors.sample': 'Не удалось проиграть пример',
  'voiceService.errors.synthesis': 'Не удалось озвучить текст',
  'voiceService.generating.title': 'ИИ генерирует озвучку',
  'voiceService.generating.caption': 'Готовим аудио',
  'voiceService.generating.desc': 'Обычно это занимает несколько секунд.',
  'voiceService.generating.note': 'Плеер появится автоматически.',
  'voiceService.hint': '',
  'voiceService.previewLabel': 'В чате текст появляется постепенно',
  'voiceService.playerLabel': 'Текст озвучки',
  'voiceService.sampleText': 'Это пример голоса. ДОиРП АИ — генерируем будущее!',
  'voiceService.voices.charon.desc': 'Уверенный тембр',
  'voiceService.voices.charon.name': 'Северин',
  'voiceService.voices.kore.desc': 'Нейтральный тембр',
  'voiceService.voices.kore.name': 'Люмира',
  'voiceService.voiceLabel': 'Голос',
  'voiceService.voicePlaceholder': 'Например: Kore, Charon',
